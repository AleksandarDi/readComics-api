...
class Login extends Component {
    ...
    componentDidMount(){
        if(sessionStorage.getItem('showSuccessMsg') === "true"){
            this.showSuccessMsg();
                            ...
                            <div className="collapse navbar-collapse" id="navbarNav">
                                <ul className="ml-auto nav flex-column">
                                    <li className="nav-item mb-3 mt-3">
                                        <form action={"http://localhost:8080/login"} method={"post"} className="form-inline">
                                            <div className="form-group">
                                                <input type="text" className="form-control form-control-sm col-sm-8 bg-transparent border text-light form-rounded" placeholder={"Username"} name={"username"} />
                                            </div>
                                            <div className="form-group">
                                                <input type="password" className="form-control form-control-sm col-sm-8 border bg-transparent text-light form-rounded" placeholder="Password" name={"password"} />
                                            </div>
                                            <button type="submit" className="btn border btn-sm text-light">Login</button>
                                        </form>
                                    </li>
