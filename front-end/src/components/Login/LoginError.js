...
import { createUser, doesUserExist } from '../../repository/readComicsApi';
                ...
                <div className="w-100 mb-5">
                    ...
                    <section className="col-lg-12 mb-2">
                        <div className="container text-center mt-3">
                            <form action={"http://localhost:8080/login"} method={"post"} className="col-lg-3 mx-auto justify-content-center align-items-center">
                                ...
                                <div className="form-group">
                                    <input type="text" className="form-control mx-auto form-control-sm col-sm-8 bg-transparent border text-dark form-rounded" placeholder={"Username"} name={"username"} />
                                </div>
                                <div className="form-group">
                                    <input type="password" className="form-control mx-auto form-control-sm col-sm-8 border bg-transparent text-dark form-rounded" placeholder="Password" name={"password"} />
                                </div>
                                <button type="submit" className="btn border-info btn-sm mt-3 mb-5 text-info">Login</button>
                            </form>
