                                    ...
                                    <li className="nav-item mb-3 mt-3">
                                        <form className="form-inline">
                                            <div className="form-group">
                                                <input type="text" className="form-control form-control-sm col-sm-8 bg-transparent border text-light form-rounded" onChange={n => this.changeLoginUsername(n)} placeholder={"Username"} name={"loginUsername"} />
                                            </div>
                                            <div className="form-group">
                                                <input type="password" className="form-control form-control-sm col-sm-8 border bg-transparent text-light form-rounded" onChange={n => this.changeLoginPwd(n)} placeholder="Password" name={"loginPwd"} />
                                            </div>
