...
import {getUserFavourites, removeFavoriteFromUser} from "../../../../../../repository/readComicsApi";
...
class FavoriteComics extends Component{
    ...
    removeFromFavorites = (comic) =>{
        removeFavoriteFromUser(sessionStorage.getItem("currentUser_id"), comic).then(
        ...
        if(this.state.favorites !== null) {
            var comics = this.state.favorites.map((comic, i) => (
                <Table.Row key={i}>
                    ...
                    <Table.Cell>
                        <Button
                            onClick={this.removeFromFavorites.bind(this, comic.id)}
                            basic color='red'
                            animated='vertical'
                            hidden={this.state.buttonDisabled}>
